const sd = {
  "app": {
    "name": "سيوا سيتو",
    "tagline": "سمارٽ ڪوآپريٽو سروس پليٽ فارم",
    "loading": "Loading...",
    "save": "Save",
    "cancel": "Cancel",
    "close": "Close",
  ...
  "voice": {
    "title": "AI آواز بڪنگ مددگار",
    "subtitle": "Say the service, date, time and problem.",
    "start": "ڳالهائي بڪ ڪريو",
  ...
  "otp": {
    "send": "OTP موڪليو",
    "verify": "OTP تصديق ڪريو",
    "verified": "موبائل تصديق ٿيل"
  }
};
