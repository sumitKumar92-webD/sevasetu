const sa = {
  "app": {
    "name": "सेवासेतुः",
    "tagline": "स्मार्ट सहकारी सेवामञ्चः",
    "loading": "Loading...",
    "save": "Save",
    "cancel": "Cancel",
    "close": "Close",
  ...
  "booking": {
    "title": "सेवां आरक्षयतु",
    "service": "सेवा",
    "datetime": "दिनाङ्कः समयश्च",
    "notes": "Notes for the worker",
    "address": "सङ्केतः",
    "emergency": "Emergency booking (+25%)",
    "submit": "उत्तमं कर्मकरं अन्विष्यतु",
  ...
  "voice": {
    "title": "AI वाणी-आरक्षण-सहायकः",
    "subtitle": "Say the service, date, time and problem.",
    "start": "उक्त्वा आरक्षयतु",
    "listening": "शृणोति...",
    "said": "You said",
  ...
  "otp": {
    "send": "OTP प्रेषयतु",
    "verify": "OTP सत्यापयतु",
    "verified": "चलदूरवाणी सत्यापिता"
  }
};
