const te = {
  "app": {
    "name": "సేవాసేతు",
    "tagline": "స్మార్ట్ సహకార సేవా వేదిక",
    "loading": "Loading...",
    "save": "Save",
    "cancel": "Cancel",
    "close": "Close",
  ...
  "booking": {
    ...
    "submit": "ఉత్తమ కార్మికుడిని కనుగొనండి",
  ...
  "voice": {
    "title": "AI వాయిస్ బుకింగ్ సహాయకుడు",
    "subtitle": "Say the service, date, time and problem.",
    "start": "మాట్లాడి బుక్ చేయండి",
    "listening": "వింటోంది...",
    "said": "You said",
  ...
  "otp": {
    ...
    "verified": "మొబైల్ ధృవీకరించబడింది"
  }
};
