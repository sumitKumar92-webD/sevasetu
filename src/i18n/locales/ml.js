const ml = {
  "app": {
    "name": "സേവാസേതു",
    "tagline": "സ്മാർട്ട് സഹകരണ സേവന പ്ലാറ്റ്ഫോം",
    "loading": "Loading...",
    "save": "Save",
    "cancel": "Cancel",
    "close": "Close",
  ...
  "voice": {
    "title": "AI വോയ്സ് ബുക്കിംഗ് സഹായി",
    "subtitle": "Say the service, date, time and problem.",
    "start": "പറഞ്ഞ് ബുക്ക് ചെയ്യുക",
